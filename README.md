...
Subsequent steps are the eigenvalue decomposition (see Eq. (20) of [1]) and mode tracking which are performed by script "No03_getCMdata.m". Tracked modal data can be plotted using "No04_plotTrackedResults.m"
